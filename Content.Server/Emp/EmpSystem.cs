...
public sealed class EmpSystem : SharedEmpSystem
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<EmpOnTriggerCComponent, TriggerEvent>(HandleEmpTrigger);
    ...
    private void HandleEmpTrigger(EntityUid uid, EmpOnTriggerCComponent comp, TriggerEvent args)
    {
